...
export default function Cobia(){

    return(
        <div className="recipe-container">
            <header className="recipe-header">
                <h1>Miso Butter-Basted Cobia with Summer Succotash</h1>
            ...
            <div className="recipe-content">
                <section className="recipe-info">
                    <h2>Ingredients</h2>
                    <ul>
                        <li>Cobia (or other firm to semi-firm fish fillet), 1” thick</li>
                        <li>2 tbsp. miso butter</li>
                        <li>2 tbsp. butter, unsalted</li>
                    </ul>
                    <h2>Miso Butter</h2>
                    <ul>
                        <li>½ cup miso, white, room temp</li>
                        <li>½ cup butter, unsalted, room temp</li>
                    </ul>
                    <h2>Summer Succotash</h2>
                    <ul>
                        <li>1 onion, diced</li>
                        <li>3 cloves garlic, sliced thin</li>
                        <li>1½ cups tomatoes, diced</li>
                        <li>1 cup corn, cooked</li>
                        <li>1 cup edamame, cooked</li>
                        <li>¼ cup country ham, small dice</li>
                        <li>2 tbsp. miso butter</li>
                    </ul>
                </section>
